  ...
  return (
    <section id="home" className="flex xl:flex-row flex-col justify-start items-center w-full min-h-screen gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className=" mt-10 font-palanquin text-8xl max-sm:[72px] max-sm:leading-[82px] font-bold"><span className=" xl:bg-white rounded-lg
      ...
      <div className="flex flex-1 relative justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        ...
        /> 
          <div className="flex absolute w-full  -bottom-[5%]  mt-20 sm-gap-6 gap-4 sm:left-[10%] max-sm:px-6">
       {shoes.map((shoe)=> (
